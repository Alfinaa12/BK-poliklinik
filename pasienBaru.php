    ...
    <div class="card-body">
      <form method="POST" action="" name="myForm" onsubmit="return(validate());">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nama" id="inputNama" required placeholder="Ketik Nama ..."
         value="<?php echo $nama ?>">
        </div>
        <div class="mb-3">
          <label for="inputalamat" class="form-label fw-bold">Alamat</label>
          <input type="text" class="form-control" name="alamat" id="inputalamat" required placeholder="Ketik Alamat ..."
            value="<?php echo $alamat ?>">
        </div>
        <div class="mb-3">
          <label for="inputNoKtp" class="form-label fw-bold">No KTP</label>
          <input type="text" class="form-control" name="no_ktp" id="inputNoKtp" required placeholder="Ketik No KTP ..."
            value="<?php echo $no_ktp ?>">
        </div>
        <div class="mb-3">
          <label for="inputNoHp" class="form-label fw-bold">No HP</label>
          <input type="text" class="form-control" name="no_hp" id="inputNoHp" required placeholder="Ketik No HP ..."
